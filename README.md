...
1. **Slice 1 (foundations, Transactions, CSV import, auth, metrics done):** Plaid sandbox and the weekly grounded Money Brief are the remaining lanes.
