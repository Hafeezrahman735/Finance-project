...
1. **Slice 1 (foundations, Transactions, CSV import, auth, metrics, brief done):** Plaid sandbox (1.4b) is the remaining lane; then Slice 1 goes to testers.
