...
Still pending for the Slice 1 lanes: Plaid sandbox (1.4b) and the weekly brief (E8). Done: auth lane 1.1 (sessions, reset, verification) and E1 (`services/metrics`, `GET /metrics`, the Overview's Numbers section).
